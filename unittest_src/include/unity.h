...
SHARED_EXPORT void setUp(void);
SHARED_EXPORT void tearDown(void);
static SetUpFunction currentSetUp = setUp;
static TearDownFunction currentTearDown = tearDown;
SHARED_EXPORT void setSetUp(SetUpFunction func);
SHARED_EXPORT void setTearDown(TearDownFunction func);
...
SHARED_EXPORT void suiteSetUp(void);
SHARED_EXPORT int suiteTearDown(int num_failures);
...
SHARED_EXPORT void resetTest(void);
SHARED_EXPORT void verifyTest(void);
