...
SHARED_EXPORT void UnityBegin(const char* filename);
SHARED_EXPORT int  UnityEnd(void);
SHARED_EXPORT void UnitySetTestFile(const char* filename);
SHARED_EXPORT void UnityConcludeTest(void);

#ifndef RUN_TEST
SHARED_EXPORT void UnityDefaultTestRun(UnityTestFunction Func, const char* FuncName, const int FuncLineNum);
#else
...
SHARED_EXPORT void UnityPrint(const char* string);

#ifdef UNITY_INCLUDE_PRINT_FORMATTED
SHARED_EXPORT void UnityPrintF(const UNITY_LINE_TYPE line, const char* format, ...);
#endif

SHARED_EXPORT void UnityPrintLen(const char* string, const UNITY_UINT32 length);
SHARED_EXPORT void UnityPrintMask(const UNITY_UINT mask, const UNITY_UINT number);
SHARED_EXPORT void UnityPrintNumberByStyle(const UNITY_INT number, const UNITY_DISPLAY_STYLE_T style);
SHARED_EXPORT void UnityPrintNumber(const UNITY_INT number_to_print);
SHARED_EXPORT void UnityPrintNumberUnsigned(const UNITY_UINT number);
SHARED_EXPORT void UnityPrintNumberHex(const UNITY_UINT number, const char nibbles_to_print);

#ifndef UNITY_EXCLUDE_FLOAT_PRINT
SHARED_EXPORT void UnityPrintFloat(const UNITY_DOUBLE input_number);
#endif
...
SHARED_EXPORT void UnityAssertEqualNumber(const UNITY_INT expected,
                            const UNITY_INT actual,
                            const char* msg,
                            const UNITY_LINE_TYPE lineNumber,
                            const UNITY_DISPLAY_STYLE_T style);

SHARED_EXPORT void UnityAssertGreaterOrLessOrEqualNumber(const UNITY_INT threshold,
                                           const UNITY_INT actual,
...
SHARED_EXPORT void UnityAssertEqualIntArray(UNITY_INTERNAL_PTR expected,
...
SHARED_EXPORT void UnityAssertBits(const UNITY_INT mask,
                     const UNITY_INT expected,
                     const UNITY_INT actual,
                     const char* msg,
                     const UNITY_LINE_TYPE lineNumber);

SHARED_EXPORT void UnityAssertEqualString(const char* expected,
                            const char* actual,
                            const char* msg,
                            const UNITY_LINE_TYPE lineNumber);

SHARED_EXPORT void UnityAssertEqualStringLen(const char* expected,
                            const char* actual,
                            const UNITY_UINT32 length,
                            const char* msg,
                            const UNITY_LINE_TYPE lineNumber);

SHARED_EXPORT void UnityAssertEqualStringArray( UNITY_INTERNAL_PTR expected,
                                  const char** actual,
                                  const UNITY_UINT32 num_elements,
                                  const char* msg,
                                  const UNITY_LINE_TYPE lineNumber,
...
SHARED_EXPORT void UnityAssertEqualMemory( UNITY_INTERNAL_PTR expected,
                             UNITY_INTERNAL_PTR actual,
                             const UNITY_UINT32 length,
                             const UNITY_UINT32 num_elements,
                             const char* msg,
...
SHARED_EXPORT void UnityAssertNumbersWithin(const UNITY_UINT delta,
                              const UNITY_INT expected,
                              const UNITY_INT actual,
                              const char* msg,
                              const UNITY_LINE_TYPE lineNumber,
...
SHARED_EXPORT void UnityAssertNumbersArrayWithin(const UNITY_UINT delta,
...
#ifndef UNITY_EXCLUDE_SETJMP_H
UNITY_NORETURN SHARED_EXPORT void UnityFail(const char* message, const UNITY_LINE_TYPE line);
UNITY_NORETURN SHARED_EXPORT void UnityIgnore(const char* message, const UNITY_LINE_TYPE line);
#else
SHARED_EXPORT void UnityFail(const char* message, const UNITY_LINE_TYPE line);
SHARED_EXPORT void UnityIgnore(const char* message, const UNITY_LINE_TYPE line);
#endif

SHARED_EXPORT void UnityMessage(const char* message, const UNITY_LINE_TYPE line);

#ifndef UNITY_EXCLUDE_FLOAT
SHARED_EXPORT void UnityAssertFloatsWithin(const UNITY_FLOAT delta,
                             const UNITY_FLOAT expected,
                             const UNITY_FLOAT actual,
                             const char* msg,
                             const UNITY_LINE_TYPE lineNumber);

SHARED_EXPORT void UnityAssertFloatsNotWithin(const UNITY_FLOAT delta,
                                const UNITY_FLOAT expected,
                                const UNITY_FLOAT actual,
                                const char* msg,
                                const UNITY_LINE_TYPE lineNumber);

SHARED_EXPORT void UnityAssertGreaterOrLessFloat(const UNITY_FLOAT threshold,
                                   const UNITY_FLOAT actual,
                                   const UNITY_COMPARISON_T compare,
                                   const char* msg,
                                   const UNITY_LINE_TYPE linenumber);

SHARED_EXPORT void UnityAssertEqualFloatArray(UNITY_PTR_ATTRIBUTE const UNITY_FLOAT* expected,
...
SHARED_EXPORT void UnityAssertFloatSpecial(const UNITY_FLOAT actual,
                             const char* msg,
                             const UNITY_LINE_TYPE lineNumber,
...
#ifndef UNITY_EXCLUDE_DOUBLE
SHARED_EXPORT void UnityAssertDoublesWithin(const UNITY_DOUBLE delta,
                              const UNITY_DOUBLE expected,
                              const UNITY_DOUBLE actual,
                              const char* msg,
                              const UNITY_LINE_TYPE lineNumber);

SHARED_EXPORT void UnityAssertDoublesNotWithin(const UNITY_DOUBLE delta,
                                 const UNITY_DOUBLE expected,
                                 const UNITY_DOUBLE actual,
                                 const char* msg,
                                 const UNITY_LINE_TYPE lineNumber);

SHARED_EXPORT void UnityAssertGreaterOrLessDouble(const UNITY_DOUBLE threshold,
                                    const UNITY_DOUBLE actual,
                                    const UNITY_COMPARISON_T compare,
                                    const char* msg,
                                    const UNITY_LINE_TYPE linenumber);

SHARED_EXPORT void UnityAssertEqualDoubleArray(UNITY_PTR_ATTRIBUTE const UNITY_DOUBLE* expected,
...
SHARED_EXPORT void UnityAssertDoubleSpecial(const UNITY_DOUBLE actual,
                              const char* msg,
                              const UNITY_LINE_TYPE lineNumber,
                              const UNITY_FLOAT_TRAIT_T style);
#endif
