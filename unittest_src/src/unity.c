...
//     __declspec(weak) void setUp(void);
//     __declspec(weak) void tearDown(void);
// #else // Assume using GCC or compatible compiler
...
void setSetUp(SetUpFunction func) {
    currentSetUp = func;
}

void setTearDown(TearDownFunction func) {
